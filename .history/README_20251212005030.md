...
-   [inception](https://github.com/younganswer/inception)
    ...
    -   dockerfile, image, compose, network, volume 등등을 사용해서 ...
...
-   [cub3D](https://github.com/younganswer/cub3d)
    ...
    -   Implemented 2D ray casting algorithm for rendering a 3D environment from a 2D map.
...
-   [philosopher](https://github.com/younganswer/42cursus/philosopher)
    -   A solution to the Dining Philosophers problem using processes and semaphores in C.
    -   Each philosopher is represented as a separate process, and semaphores are used to manage access to shared resources (forks) to prevent deadlock and starvation.
